  ...
  <table class="table table-responsive">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><img src="{{url('public/category',$d->category_image)}}" height="200" width="200"></td>
        <td><a href="{{url('category/delete',$d->id)}}" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>
